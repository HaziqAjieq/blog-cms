...
export const examplePost = [
  ...
  new BlogPost({
    ...
    published_at: getRandomDate(),
    user: breyguire,
    platform: [pcPlatform, ps5Platform, xboxPlatform],
    tags: [],
    status: "published",
  }),
  ...
  new BlogPost({
    ...
    published_at: getRandomDate(),
    user: tehbeng,
    platform: [ps5Platform, pcPlatform, nintendoPlatform],
    tags: [storyRich],
    status: "published",
  }),
  ...
  new BlogPost({
    ...
    published_at: getRandomDate(),
    user: haziqajieq,
    platform: [pcPlatform, mobilePlatform],
    tags: [eSport],
    status: "published",
  }),
  ...
  new BlogPost({
    ...
    published_at: getRandomDate(),
    user: tehbeng,
    platform: [pcPlatform, nintendoPlatform],
    tags: [indie],
    status: "published",
  }),
  ...
  new BlogPost({
    ...
    published_at: getRandomDate(),
    user: haziqajieq,
    platform: [ps5Platform, xboxPlatform, pcPlatform, mobilePlatform],
    tags: [],
    status: "published",
  }),
  ...
  new BlogPost({
    ...
    published_at: getRandomDate(),
    user: tehbeng,
    platform: [mobilePlatform, ps5Platform, xboxPlatform],
    tags: [],
    status: "published",
  }),
  ...
  new BlogPost({
    ...
    published_at: getRandomDate(),
    user: haziqajieq,
    platform: [mobilePlatform, pcPlatform],
    tags: [],
    status: "published",
  }),
